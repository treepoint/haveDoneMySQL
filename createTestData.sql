...
#Статусы_задач
insert into task_statuses (user_id, type_id, name) VALUES (1, 1, "Waiting");
insert into task_statuses (user_id, type_id, name) VALUES (1, 1, "Partially completed");
insert into task_statuses (user_id, type_id, name) VALUES (1, 2, "Completed");
insert into task_statuses (user_id, type_id, name) VALUES (1, 1, "Wait for feedback");

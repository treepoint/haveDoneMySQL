...
#Задачи
insert into tasks (user_id, category_id, name, description, create_date) 
VALUES (1, 1, "test task", "test task description", "2019-12-19");

insert into tasks (user_id, category_id, name, description, create_date) 
VALUES (1, 1, "test task 2", "new test task description", "2019-12-20");
